/// \file btg_file.h
/// Parser for FlightGear Binary Terrain Grid files.
...
/// Reads a .btg or .btg.gz file into triangle groups the shader can upload.
class BtgFile
{
public:
    ...
    /// Sphere stored in the file, in tile-local metres.
