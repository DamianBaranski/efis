/// \file geo_coord_utils.h
/// WGS-84 and Earth-centered conversions used by the 3D camera.
#ifndef GEO_COORD_UTILS_H
#define GEO_COORD_UTILS_H

#include <cmath>

/// WGS-84 geodetic conversions and the ground-camera orientation.
class GeoCoordUtils
{
public:
    /// Earth-centered metres.
    struct XYZ
    {
        double x; ///< Metres.
        double y; ///< Metres.
