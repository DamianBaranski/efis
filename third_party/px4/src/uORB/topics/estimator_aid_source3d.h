/// Minimal stand-in for the PX4 uORB topic the EKF writes its 3-axis aid status into.
#ifndef EFIS_ESTIMATOR_AID_SOURCE3D_H
#define EFIS_ESTIMATOR_AID_SOURCE3D_H
